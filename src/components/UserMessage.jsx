...
export const UserMessage = (props) => {
  return (
    <div className='self-end flex flex-col items-end mr-[10px]'>
          ...
          <p className="bg-[#3586F0] mt-[5px] inline-block max-w-[800px] pt-[25px] pb-[25px] pl-[7px] pr-[7px] rounded-b-[13px] rounded-tl-[13px] text-white font-semibold animate-fade-up animate-duration-[500ms]">{props.input}</p>
    </div>
  )
}
